...
HD_PWD='C:/Users/georg/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log First_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source First_example.tcl
