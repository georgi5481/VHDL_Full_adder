...
HD_PWD='C:/Users/georg/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log First_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source First_example.tcl -notrace
